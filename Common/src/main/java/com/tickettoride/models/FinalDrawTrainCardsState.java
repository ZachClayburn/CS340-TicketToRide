...
public class FinalDrawTrainCardsState extends PlayerState {
    ...
    public FinalDrawTrainCardsState(PlayerStateID playerStateID, PlayerID playerID, GameID gameID) {
        super(playerStateID, playerID, gameID);
        type = this.getClass().getName();
    }
    public FinalDrawTrainCardsState(PlayerID playerID, GameID gameID) {
        super(playerID, gameID);
        type = this.getClass().getName();
    }

    public FinalDrawTrainCardsState(Map<String, Object> playerStateMap) {
