...
public class DrawDestinationState extends PlayerState {
    public DrawDestinationState(PlayerStateID playerStateID, PlayerID playerID, GameID gameID) {
        super(playerStateID, playerID, gameID);
        type = this.getClass().getName();
    }
    public DrawDestinationState(PlayerID playerID, GameID gameID) {
        super(playerID, gameID);
        type = this.getClass().getName();
    }

    public DrawDestinationState(Map<String, Object> playerStateMap) {
