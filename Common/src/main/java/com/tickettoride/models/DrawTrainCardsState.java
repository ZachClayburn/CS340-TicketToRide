...
public class DrawTrainCardsState extends PlayerState {
    public DrawTrainCardsState(PlayerStateID playerStateID, PlayerID playerID, GameID gameID) {
        super(playerStateID, playerID, gameID);
        type = this.getClass().getName();
    }
    public DrawTrainCardsState(PlayerID playerID, GameID gameID) {
        super(playerID, gameID);
        type = this.getClass().getName();
    }

    public DrawTrainCardsState(Map<String, Object> playerStateMap) {
